...
Output your research as clean, well-structured Markdown text. Do not generate a PDF, JSON file, or any other file format. The pastor will read this directly in the app.

Use Markdown headers, tables, and lists so the output is easy to scan on screen. Follow this structure:

```markdown
# Sermon Research: [Passage Reference]

**Date:** [current date]
**Pastor:** [PASTOR_NAME from foundation]
**Church:** [CHURCH_NAME from foundation]
...
| English | Transliteration | Literal Meaning | Range of Meaning | NIV | ESV | KJV | NLT | NASB |
|---|---|---|---|---|---|---|---|---|
| ... | ... | ... | ... | ... | ... | ... | ... | ... |
